...
- [`gymhub_expotecnica/README.md`](/mnt/c/dev/proyectos/proyectoappgym/docs/gymhub_expotecnica/README.md): modelo de negocio institucional de GymHub para ExpoTÉCNICA 2026, encuesta y PDF compilable.
