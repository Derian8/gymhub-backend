...
instrumento incluido en los anexos se encuentra en aplicación y todavía no se
dispone de una tabulación final.

\datoencuestapendiente{determinar la frecuencia de los problemas administrativos,
deportivos y comerciales en los gimnasios consultados.}
...
empresa operativa. La hipótesis comercial propone una cuota mensual por gimnasio
de CRC 30\,000, que incluye hasta 50 miembros activos, más CRC 350 por cada
miembro activo adicional. El gimnasio es el cliente facturado; entrenadores,
administradores y miembros utilizan la plataforma sin recibir cobros individuales
de GymHub.
...
\datoencuestapendiente{confirmar o rechazar la hipótesis de que los registros
separados constituyen un problema frecuente en Pérez Zeledón.}
...
precio con el tamaño del gimnasio. El precio definitivo dependerá de la
disposición de pago observada en la encuesta, de los costos reales del piloto y
del soporte requerido.

\datoencuestapendiente{establecer la disposición de pago y contrastar la cuota
base y el cobro por miembros activos.}
...
Las afirmaciones que requieren la tabulación final de la encuesta se identifican
en color rojo como información pendiente y no se presentan como resultados.
