...
\midrule
Producto & Plataforma web con incorporación y soporte inicial. & Demostrar miembros, planes de entrenamiento, membresías, cobros y asistencia como recorridos diferenciados. \\
...
\bottomrule
\end{tabularx}
\caption*{\textit{Nota}. Los niveles comerciales indican cuánto paga el gimnasio por el servicio y no son planes de entrenamiento ni membresías individuales. Incluyen las cuentas necesarias para entrenadores y miembros. Se considera activo al miembro con membresía vigente al cierre del ciclo.}
\end{table}
...
\midrule
Gimnasio local aliado & Contexto, prueba y retroalimentación. & Validación operacional. & Requerido; no confirmado \\
