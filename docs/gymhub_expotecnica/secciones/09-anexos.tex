...
Capturas anonimizadas & Administración, facturación, asistencia, planes del instructor y experiencia del cliente en escritorio y móvil, con datos ficticios. & Disponible \\
\bottomrule
\end{tabularx}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{imagenes/captura_actual_movil_instructor.png}
\caption{Panel móvil del instructor}
\caption*{\textit{Nota}. Captura propia de la versión local de demostración con datos ficticios, 23 de septiembre de 2026.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{imagenes/captura_actual_movil_miembro.png}
\caption{Panel móvil del cliente}
\caption*{\textit{Nota}. Captura propia de la versión local de demostración con datos ficticios, 23 de septiembre de 2026.}
\end{figure}
...
y cliente en escritorio, además de los paneles móvil de instructor y cliente
con una ventana de 390 por 844 píxeles. La ejecución se realiza sobre un entorno
local temporal con cuentas y datos ficticios; no usa datos de gimnasios ni
modifica el despliegue público.
