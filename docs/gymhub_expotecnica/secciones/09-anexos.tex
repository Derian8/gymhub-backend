...
\centering
\vspace*{0.5cm}
\input{secciones/canvas-regional}
...
versión del MVP de julio de 2026 con cuentas y datos ficticios.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{imagenes/captura_panel_entrenador.png}
\caption{Panel de control del entrenador en el MVP}
\caption*{\textit{Nota}. Captura propia con datos ficticios, 31 de julio de 2026.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{imagenes/captura_planes_entrenador.png}
\caption{Listado y gestión de planes de entrenamiento}
\caption*{\textit{Nota}. Captura propia con datos ficticios, 31 de julio de 2026.}
\end{figure}
...
\caption{Panel de seguimiento de un miembro}
\caption*{\textit{Nota}. Captura propia con datos ficticios, 24 de julio de 2026.}
\end{figure}
...
Playwright y Chromium para capturar el panel y las funciones de planes en
escritorio, además de los paneles de entrenador y miembro con una ventana de
390 por 844 píxeles. La ejecución se realiza sobre el entorno de demostración
con cuentas ficticias y no modifica datos. Las nuevas capturas móviles se
agregarán a este apéndice después de su ejecución en un equipo con acceso
continuo al backend de demostración.
