...
Capturas anonimizadas & Gestión de planes del instructor, con datos ficticios. & Disponible \\
\bottomrule
\end{tabularx}
...
\caption{Gestión de planes de entrenamiento por el instructor}
...
las capturas comprobadas de administración e instructor; el recorrido visual
del cliente y las vistas móviles se repetirán antes de la entrega si el entorno
local está disponible. La ejecución usa cuentas y datos ficticios; no emplea
datos de gimnasios ni modifica el despliegue público.
