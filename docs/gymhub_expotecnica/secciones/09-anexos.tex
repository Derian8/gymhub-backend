...
Investigación de necesidades & Instrumento en aplicación con rutas para responsables y miembros adultos. & \textcolor{red}{Resultados pendientes} \\
Desarrollo tecnológico & Arquitectura, módulos, pruebas y limitaciones documentadas. & Documentado \\
Modelo de negocio & Canvas, suscripción mensual y personalización básica propuestas. & Provisional \\
Viabilidad económica & Costos, ingresos proyectados y punto de equilibrio inicial. & Provisional \\
Piloto o demostración & Diseño, indicadores y condiciones de privacidad definidos. & Pendiente \\
Evidencia de exposición & Repositorio y despliegues disponibles; capturas y video por incorporar. & Parcial \\
\bottomrule
\end{tabularx}
