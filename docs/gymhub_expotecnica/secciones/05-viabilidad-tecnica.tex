...
Construimos GymHub con una arquitectura web modular para separar la interfaz, las
...
Comprobamos los principales recorridos de GymHub mediante pruebas automatizadas
...
antes de que afecten a la persona usuaria \parencite{pressman2010}. Entre los
...
Esto permite que el jurado observe el producto en funcionamiento y no solamente
su diseño. También preparamos capturas con datos ficticios como respaldo para la
presentación.
...
definir el procedimiento de soporte. También implementaremos almacenamiento
