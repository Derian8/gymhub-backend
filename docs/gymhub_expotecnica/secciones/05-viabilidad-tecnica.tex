...
La versión documentada en las pruebas y capturas de julio de 2026 tiene dos
roles: entrenador y miembro. El entrenador gestiona miembros, rutinas,
asistencia y facturación. El miembro consulta su membresía y sigue el programa
asignado. En esa versión, la administración se realiza desde el rol entrenador.
...
La Figura~\ref{fig:planes-entrenador} muestra cómo la rutina se crea, asigna,
...
La Figura~\ref{fig:facturacion-entrenador} muestra la membresía de cada miembro,
...
La Figura~\ref{fig:panel-miembro} muestra la consulta de membresía,
entrenamiento del día, indicaciones del entrenador y progreso.
