...
\datoencuestapendiente{caracterizar el tamaño, las herramientas actuales y las
necesidades del segmento local consultado.}
...
\datoencuestapendiente{identificar los canales preferidos y la intención de
participar en una demostración o prueba piloto.}
...
\datoencuestapendiente{priorizar cuáles problemas administrativos, deportivos y
comerciales deben resolverse primero.}
...
según sus miembros activos. El gimnasio adquiere derecho de uso, actualizaciones,
personalización básica y soporte inicial. La estructura sigue cuatro dimensiones:
...
\datoencuestapendiente{validar los segmentos, la propuesta de valor, los canales
y la disposición de pago representados en el Canvas.}
...
Ingreso & CRC 30\,000 mensuales hasta 50 miembros activos y CRC 350 por cada miembro activo adicional. \\
Entrega & Acceso web responsive con acompañamiento inicial. \\
Personalización & Logo, nombre y colores del gimnasio dentro de la aplicación compartida. \\
Mercado inicial & Pérez Zeledón y zonas cercanas; \textcolor{red}{tamaño pendiente de resultados de encuesta}. \\
