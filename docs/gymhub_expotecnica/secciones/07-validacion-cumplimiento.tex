...
Pit Bull Gym, ubicado en Mollejones, es el gimnasio aliado de Pulso para la
prueba inicial. La administración mostró disposición para probar la aplicación
y valoró positivamente su potencial. El piloto todavía no ha comenzado; la
alianza corresponde a esta etapa de validación y no supone una compra ni una
contratación a largo plazo. La propuesta general contempla un piloto de cuatro
semanas por CRC 15\,000; este importe no se presenta como aceptado por el aliado.
La prueba comenzará con datos ficticios durante la capacitación y utilizará
datos reales únicamente después de acordar consentimiento, seguridad y
responsabilidades.

Las dos respuestas favorables al piloto en la encuesta se obtuvieron de manera
anónima y son independientes de la alianza con Pit Bull Gym. La relación con el
gimnasio surgió mediante un acercamiento separado del equipo; por ello, no se
vincula su identidad con las respuestas de la encuesta.
