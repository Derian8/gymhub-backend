...
Aplicamos la encuesta mediante Google Forms entre el 8 y el 24 de julio de 2026.
...
con responsabilidades administrativas y diez miembros. Alcanzamos la meta de
miembros, mientras que el acceso a responsables fue más difícil porque varios
dueños rechazaron participar. Conservamos las cinco respuestas administrativas
obtenidas y las utilizamos como información descriptiva para orientar el piloto.
...
Por ello diseñamos un piloto de CRC 15\,000 que permite conocer GymHub antes de
seleccionar uno de los planes regulares.
...
aplicado se conservan en los anexos.

\subsection{Diseño del piloto}

Después de analizar la encuesta seleccionaremos un gimnasio con una persona
...
cuentas de demostración. Antes de operar con clientes revisaremos la base legal y
los procedimientos definitivos conforme a la Ley n.º 8968
\parencite{ley8968}.

Las imágenes incluidas son propias, licenciadas o citadas. No utilizamos logos de
...
segundo periodo de 2025. En 2026 ampliamos la primera versión y la preparamos para
nuestra primera participación en ExpoTÉCNICA. Por no haberse presentado en una
edición anterior, se inscribe como proyecto nuevo y no como proyecto de
continuación. Actualmente contamos con un MVP funcional, una demostración web y
una estrategia definida para realizar el primer piloto.
